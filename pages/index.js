...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <p>
        Warm Spot built the Six Dice app as a Commercial app. This SERVICE is
        provided by Warm Spot and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Six Dice unless otherwise
      ...
      <p>
        ...
        but not limited to Name, Addresses, Asset information, Personal
        features, Geographical location, . The information that we request will
      ...
      <p>This policy is effective as of 2021-09-13</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at support@sixdice.online.
      </p>{" "}
      <p>
